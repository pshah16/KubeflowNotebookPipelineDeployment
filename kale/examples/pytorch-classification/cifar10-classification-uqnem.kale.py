...
@dsl.pipeline(
    name='cifar10-classification-uqnem',
...
def auto_generated_pipeline(TRAIN_STEPS='2'):
    ...
    dataprocessing_task = dataprocessing_op(TRAIN_STEPS)\
        ...
        .after()
    dataprocessing_task.container.working_dir = "/home/jovyan/kale/examples/pytorch-classification"
    ...
    train_task.container.working_dir = "/home/jovyan/kale/examples/pytorch-classification"
    ...
    testontest_task = testontest_op(TRAIN_STEPS)\
        .add_pvolumes(pvolumes_dict)\
        .after(train_task)
    testontest_task.container.working_dir = "/home/jovyan/kale/examples/pytorch-classification"
    ...
    testwhole_task.container.working_dir = "/home/jovyan/kale/examples/pytorch-classification"
...
if __name__ == "__main__":
    ...
    run_name = 'cifar10-classification-uqnem_run'
